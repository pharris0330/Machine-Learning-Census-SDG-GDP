...
layout = html.Div([
    html.H1('US GDP', style={"textAlign": "center"}),

    html.Div([
        html.Div([
            html.Pre(children="gdp_quartile", style={"fontSize":"150%"}),
            dcc.Dropdown(
                id='pymnt-dropdown', value='Type', clearable=False,
        ...
        html.Div([
            html.Pre(children="Bachelors", style={"fontSize": "150%"}),
            dcc.Dropdown(
                id='country-dropdown', value='Order Country', clearable=False,
